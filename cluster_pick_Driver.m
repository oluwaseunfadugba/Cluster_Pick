...
arg_kmin = 1; arg_kmax=100; arg_err_av = 1; 
arg_hypo_infile = 'testdata.txt';
arg_clus_mineqs = 4; arg_N_loop = 1; 
arg_dip_threshold = 10; arg_FM_file = '';%'All_write_mechanisms_99.txt'; %'';%
...
for i= 1:100
    ...
    arg_simul_tag = ['Syn_Faults.i.' num2str(i)];
