function datplot_with_colors_sep_spurious_faults(xs,ys,zs,n0,xv,yv,zv,xt, yt, zt, Nt,picname)

hold on;
plot3(xs,ys,zs,'.'); hold on %,'MarkerEdgeColor','k','MarkerFaceColor','k'
...
for k=2:n0
    plot3(xt(k,1:Nt(k)),yt(k,1:Nt(k)),zt(k,1:Nt(k)),'o','MarkerEdgeColor',...
        'k','MarkerFaceColor',colors(mod(k,11)+2,:)); hold on;%'k'
end
