function perform_clustering_edit_2D()
...
ncalc;
V05=vr(ncalc);
fprintf('ncalc = %i, Area at 5 percent probability (A05, km squared) = %g\n',ncalc,V05);
...
fprintf('ncat = %i, Probability at target area (NA05) = %g\n',ncalc,NV05_cat);
...
grid(h3_decl,'MINOR')
legend(h3_decl,'Random','Observed','A05',num2str(round(PROB,2)),'Location','best');
...
scatter(h2_decl,xs_clu,ys_clu,'filled','MarkerEdgeColor','k',...
...
% ------------------------------
scatter(h4_decl,xs_diffuse,ys_diffuse,'filled','MarkerEdgeColor','k',...
        'MarkerFaceColor',[0 0.75 0])   
set(h4_decl,'NextPlot','add');
scatter(h4_decl,xs_clu,ys_clu,'filled','MarkerEdgeColor','k',...
        'MarkerFaceColor',[0 0 1])
